//
//  GLTouchDrawingView.m
//  OpenGL-纹理绘图
//
//  Created by zj-db0631 on 2017/6/28.
...
@implementation GLTouchDrawingView
...
- (void)setUp
{
    ...
    _EALayer.opaque = YES;
    //    _EALayer.cornerRadius = self.frame.size.height/2;
    //    _EALayer.masksToBounds = YES;
    
    // 先要编译vertex和fragment两个shader
    NSString *shaderVertex = @"RoundnessVertexTriangle";
    NSString *shaderFragment = @"RoundnessFragmentTriangle";
...
//    NSLog(@"x1 = %f   x2 = %f  x3 = %f  x4 = %f",p1.x, p2.x, p3.x, p4.x);
    GLfloat vertices3[] = {
        p1.x, p1.y,
        p2.x, p2.y,
        p3.x, p3.y,
